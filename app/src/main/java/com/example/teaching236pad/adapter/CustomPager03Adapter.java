 ...
 */
public class CustomPager03Adapter extends PagerAdapter {
    ...
    public CustomPager03Adapter(Context context, List<Courseware> list) {
    ...
    public Object instantiateItem(View container, int position) {
        ...
        View view = inflater.inflate(
                R.layout.layout_adapter_item_for_courseware, null);

        ImageView iv = (ImageView) view.findViewById(R.id.iv_file_show);
...
//                .error(res.getDrawable(R.drawable.no_data)).into(iv);
        iv.setBackground(context.getResources().getDrawable(list.get(position).getPicResID()));
