 ...
 * 自定义阴影属性的弹出框基类
 */
public class BgDarkPopupWindow extends PopupWindow {
    ...
    private WeakReference<View> mRightOfPositionView, mLeftOfPositionView, mBelowPositionView, mAbovePositionView,
            mFillPositionView;
    private boolean mIsDarkInvoked = false;

    private View mDarkView;

    public BgDarkPopupWindow(Context context, View contentView, int width, int height) {
        ...
        if (contentView != null) {
            ...
            mDarkView.setLayoutParams(new FrameLayout.LayoutParams(FrameLayout.LayoutParams.MATCH_PARENT,
    ...
    public void resetDarkPosition() {
        ...
        mRightOfPositionView = mLeftOfPositionView = mBelowPositionView = mAbovePositionView = mFillPositionView = null;
    }
    ...
    public void drakFillView(View view) {
        mFillPositionView = new WeakReference<View>(view);
    ...
    public void darkRightOf(View view) {
        mRightOfPositionView = new WeakReference<View>(view);
        view.getLocationInWindow(mLocationInWindowPosition);
    ...
    public void drakLeftOf(View view) {
        mLeftOfPositionView = new WeakReference<View>(view);
        view.getLocationInWindow(mLocationInWindowPosition);
    ...
    public void darkAbove(View view) {
        mAbovePositionView = new WeakReference<View>(view);
        view.getLocationInWindow(mLocationInWindowPosition);
    ...
    public void darkBelow(View view) {
        mBelowPositionView = new WeakReference<View>(view);
        view.getLocationInWindow(mLocationInWindowPosition);
